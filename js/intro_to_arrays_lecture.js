...
var faveFood =["pizza", "hot cheetos", "ice cream", "tacos", "biryani"];
...
console.log("The length of favorite foods array is: " + faveFood.length);
...
// TODO TOGETHER: What do we expect the following to output?
	...
	console.log(shapes[3]); //triangle
 	console.log(shapes[4]); //undefined --> this dont exist guh
