...
//first example the value is undefined and in the second one the variable itself is not defined. You are calling a variable that doesn’t exist
/*==============================================*/
...
}
{
    ...
    //bc it is only in this artificial block here
}
...
//have to use return in curly braces if you have more than one line of code
