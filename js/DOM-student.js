...
//lecture practice
//lets grab our LIs with the class hat-sold

var topSellers = document.getElementsByClassName("hat-sold");

console.log(topSellers);

//UH OH those were LAST months top sellers, these list items to say "Hat TBD" and be STRONG about it (without ever touching HTML)
